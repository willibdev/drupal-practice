  ...
  public function save(array $form, FormStateInterface $form_state): int {
    ...
    switch ($result) {
      case SAVED_NEW:
        ...
        $this->logger('performance_lab')->notice('New product %label has been created.', $logger_args);
        break;

      case SAVED_UPDATED:
        $this->messenger()->addStatus($this->t('The product %label has been updated.', $message_args));
        $this->logger('performance_lab')->notice('The product %label has been updated.', $logger_args);
        break;
